...
public class AppointmentService {
	...
	public String appointment(Appointment appointment) throws InvalidInputException {
		...
		Appointment savedAppointment = appointmentRepository.findByDoctorIdAndTimeSlotAndAppointmentDate(appointment.getDoctorId(),appointment.getTimeSlot(),appointment.getAppointmentDate());
